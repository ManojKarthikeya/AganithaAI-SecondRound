	...
	return (
		<div className="introduction-container">
			<div className="introduction">
				...
				<p>
					We are now offering operation services to more nascent
					games, helping them and their developers grow. We are proud
					of who we are, what we do, and how we contribute.
				</p>
			</div>
		</div>
	);
